...
class ApplicationForm(models.Model):
    ...
    confirm_date = models.PositiveIntegerField(null=True, blank=True)
    offer_date = models.PositiveIntegerField(null=True, blank=True)
    payment_state = models.CharField(max_length=100, choices=STATE, null=True)
    start_date = models.PositiveIntegerField(null=True, blank=True)
    finish_date = models.PositiveIntegerField(null=True, blank=True)
    description = models.CharField(blank=True, null=True, max_length=200)
    files = models.ImageField(upload_to='', null=True, blank=True)
