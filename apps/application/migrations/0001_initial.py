    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deadline_date', models.CharField(blank=True, max_length=20, null=True, verbose_name='Срок выполнения')),
            ],
            options={
                'verbose_name': 'Заявка',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user', models.CharField(blank=True, max_length=100, null=True, verbose_name='Пользователь')),
                ('field', models.CharField(blank=True, max_length=500, null=True, verbose_name='Название поля')),
                ('initially', models.CharField(blank=True, max_length=500, null=True, verbose_name='Старое значение')),
                ('new', models.CharField(blank=True, max_length=500, null=True, verbose_name='Новое значение')),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Дата и время создания')),
                ('file_logs', models.FileField(blank=True, null=True, upload_to='', verbose_name='Файл картинки')),
                ('user_image', models.FileField(blank=True, null=True, upload_to='', verbose_name='Аватар пользователя')),
