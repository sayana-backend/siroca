...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='application',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='checklists', to='application.applicationform', verbose_name='Заявки'),
        ),
        migrations.AddField(
            model_name='checklist',
            name='manager',
