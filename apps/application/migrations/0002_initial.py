# Generated by Django 4.2 on 2024-04-05 15:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='manager',
            field=models.ForeignKey(blank=True, limit_choices_to={'is_manager': True}, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Отмеченный менеджер'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='check_list',
            field=models.ManyToManyField(blank=True, null=True, related_name='checklist', to='application.checklist', verbose_name='Чек-лист'),
        ),
        migrations.AddField(
            model_name='applicationform',
            name='company',
