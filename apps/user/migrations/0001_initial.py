    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manager_can_create_and_edit_company_extra', models.BooleanField(null=True, verbose_name='Создание/Редактирование/Удаление компании')),
                ('manager_can_create_and_edit_user_extra', models.BooleanField(null=True, verbose_name='Создание/Редактирование/Удаление пользователя')),
                ('manager_can_create_and_delete_job_title_extra', models.BooleanField(null=True, verbose_name='Создание/Редактирование/Удаление должности')),
        ...
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ('userspermissions_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='user.userspermissions')),
                ('password', models.CharField(max_length=128, verbose_name='password')),
                ('last_login', models.DateTimeField(blank=True, null=True, verbose_name='last login')),
                ('role_type', models.CharField(choices=[('client', 'Клиент'), ('manager', 'Менеджер')], default='', max_length=20, verbose_name='Тип роли')),
                ...
                ('managers_company', models.ManyToManyField(related_name='managers_company', to='company.company', verbose_name='Компании менеджеров')),
            ...
            bases=('user.userspermissions', models.Model),
            managers=[
